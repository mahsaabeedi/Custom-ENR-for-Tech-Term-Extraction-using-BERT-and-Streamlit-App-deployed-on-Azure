...
model = Sequential()
model.add(keras.layers.recurrent.SimpleRNN(32,input_shape=(11,8),return_sequences=False))
model.add(Dropout(0.1))
model.add(Dense(1, activation='sigmoid'))
model.compile(loss='mean_squared_error', optimizer='RMSprop', metrics=['accuracy'])#mean_squared_error   adam   RMSprop
print(model.summary())
